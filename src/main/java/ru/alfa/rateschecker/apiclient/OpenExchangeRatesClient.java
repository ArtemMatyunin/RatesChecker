...
@FeignClient(name = "OpenExchangeRatesClient", url = "${api.params.openexchangerates.url}")
public interface OpenExchangeRatesClient {

    @GetMapping(value = "${api.params.openexchangerates.latestendpoint}",
    ...
    @GetMapping(value = "${api.params.openexchangerates.historycalendpoint}/{date}.json",
            params = "{app_id, base, symbols}",
            consumes = MediaType.APPLICATION_JSON_VALUE)
